...
{
    /// <summary>
    /// Provides methods for retrieving pages of type Song.
    /// </summary>
    public partial class SongProvider
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns a published page of type Song that matches the specified criteria.
        /// </summary>
        ...
        public static DocumentQuery<Song> GetSong(int nodeId, string cultureName, string siteName)
        {
            return GetSongs().OnSite(siteName).Culture(cultureName).WhereEquals("NodeID", nodeId);
        }
        ...
        /// <param name="siteName">The name of the site where the page belongs.</param>
        /// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
        public static DocumentQuery<Song> GetSong(Guid nodeGuid, string cultureName, string siteName)
        {
            return GetSongs().OnSite(siteName).Culture(cultureName).WhereEquals("NodeGUID", nodeGuid);
        }
        ...
        /// <param name="siteName">The name of the site where the page belongs.</param>
        /// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
        public static DocumentQuery<Song> GetSong(string nodeAliasPath, string cultureName, string siteName)
        {
            return GetSongs().OnSite(siteName).Culture(cultureName).Path(nodeAliasPath);
        }
    }
}